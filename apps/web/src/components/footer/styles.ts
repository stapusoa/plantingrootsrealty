{/* export const styles = {
  container: 'bg-gray-900 text-white py-12 px-6',
  contentWrapper: 'max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center',
  socials: 'flex space-x-6',
  socialLink: 'text-gray-400 hover:text-white',
  nav: 'mt-8 md:mt-0 flex space-x-8',
  navLink: 'text-gray-300 hover:text-white',
  copyright: 'mt-8 md:mt-0 text-gray-400 text-sm',
};
*/}
