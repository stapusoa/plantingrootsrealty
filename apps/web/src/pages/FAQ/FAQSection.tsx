          ...
          <div className="max-w-[1140px] relative shrink-0 w-full">
            ...
            <Accordion type="single" collapsible className="w-full space-y-4">
              {faqs.map((faq, index) => (
                ...
                >
                  <AccordionTrigger className="font-['Merriweather:Bold',sans-serif] text-[#1a1a1a] text-[18px] font-semibold text-left hover:no-underline hover:text-grape-800 transition-colors">
                    {faq.question}
                  </AccordionTrigger>
                  <AccordionContent className="font-['Karla:Regular',sans-serif] text-[#606060] text-[16px] leading-relaxed pt-4">
                    {faq.answer}
                  </AccordionContent>
                </AccordionItem>
              ))}
